		...
		<div class="row mb-2">
			...
			<div class="col-sm-6">
				<ol class="breadcrumb float-sm-right">
					...
					<li class="breadcrumb-item">Perbaharui Data {{ $absensi_masuk->enkripsi }}</li>
				</ol>
			</div>
		</div>
	</div><!-- /.container-fluid -->
							...
							<div class="card-body">
								<form action="{{ route('absensi_masuk.post', $absensi_masuk->id) }}" method="POST">
									...
									<div class="form-group">
										...
										<input type="text" name="enkripsi" class="form-control" value="{{ $absensi_masuk->enkripsi }}" readonly>
									</div>
									<div class="form-group">
										<label for="waktu">Waktu Scan*</label>
										<input type="text" name="waktu_scan" class="form-control" value="{{ $absensi_masuk->waktu_scan }}" readonly>
									</div>
									<div class="form-group">
										<label for="id_guru">ID Guru*</label>
										<input type="text" name="guru_id" class="form-control" value="{{ $absensi_masuk->guru_id }}" readonly>
									</div>
									<div class="form-group">
