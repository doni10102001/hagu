    ...
    <div class="row mb-2">
      ...
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
          ...
          <li class="breadcrumb-item"><a href="{{ route('qr') }}" class="text-dark">QR Kode Absensi Masuk</a></li>
        </ol>
      </div>
    </div>
  </div><!-- /.container-fluid -->
      ...
      <div class="col-12">
        <div class="card">
          <div class="card-header">
            ...
            <a href="{{ route('qr.tambah') }}" class="btn btn-success"><i class="fas fa-plus-circle fa-fw"></i>Tambah Data</a>
            <div class="card-tools">
              ...
              <div class="card-body">
                <table id="qr_in" class="table table-bordered">
                  <thead>
                    <tr role="row">
                      <th>No</th>
                      <th>Enkripsi</th>
